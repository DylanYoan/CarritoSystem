    ...
    public class CD_Producto
    {
        ...
        public List<Producto> Listar()
        {
            ...
            try
            {
                ...
                {                   
                    ...
                    sb.AppendLine("c.IdCategoria, c.Description[DesCategoria],");
                    ...
                    using (SqlDataReader dr = cmd.ExecuteReader())
                    {
                        while (dr.Read())
                        {
                            lista.Add(new Producto
                            {
                                ...
                                oCategoria = new Categoria() { IdCategoria = Convert.ToInt32(dr["IdCategoria"]), Description = dr["DesCategoria"].ToString() },
        ...
        public bool Eliminar(int id, out string Mensaje)
        {
            ...
            try
            {
                using (SqlConnection oconexion = new SqlConnection(Conexion.cn))
                {
                    SqlCommand cmd = new SqlCommand("delete top (1) from PRODUCTO where IdProducto = @id", oconexion);
